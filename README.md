...
- `cockpit-agent` exposes ten typed simulation tools, including bounded human-owned Goal/wait controls, capability enforcement, a RuleAgent, a timeout-only execution policy, and an iota-core SkillRegistry adapter.
