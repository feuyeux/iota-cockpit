...
use cockpit_simulation_core::{NeedsState, PerceivedEvent, Persona, simulation::Simulation};
...
/// converted into an [`cockpit_simulation_core::ActionRequest`] and validated
...
/// deterministic [`cockpit_simulation_core::simulation::StepRecord`] as
