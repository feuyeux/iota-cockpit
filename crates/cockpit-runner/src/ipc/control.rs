//! `RunnerHandler` methods for action approval/rejection, agent-turn
...
use cockpit_simulation_core::{Simulation, StateDiff, clock::RunStatus};
use serde_json::{Value, json};

use super::handler::{HandlerResult, RunnerHandler, plugin_failure_record, read_recording};
use super::proto::{IpcError, RunnerEvent};
...
impl RunnerHandler {
    ...
    pub(super) fn events_after(&self, cursor: Option<u64>) -> Vec<RunnerEvent> {
