//! `RunnerHandler` methods for simulation run lifecycle: scenario
...
use cockpit_simulation_core::{Simulation, SimulationScenario, clock::RunStatus};
use serde_json::json;

use crate::live_run::backend_impl::backend_session;

use super::handler::{HandlerResult, RunnerHandler, deadline_reached, plugin_failure_record};
