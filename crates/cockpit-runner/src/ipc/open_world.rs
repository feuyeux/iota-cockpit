//! `RunnerHandler` methods for the open-world dynamic entity/agent-goal IPC
...
use cockpit_simulation_core::DynamicEntity;
use serde_json::json;

use super::handler::{HandlerResult, RunnerHandler};
...
impl RunnerHandler {
    ...
    pub(super) fn checkpoint_open_world(&mut self) -> HandlerResult {
        ...
        Ok(json!({
            "checkpointVersion": cockpit_agent_runtime::open_world::OPEN_WORLD_RUNTIME_VERSION,
            "tick": tick,
            "agents": agent_count,
