...
3. Layer 3: "Simulation Core & Recording" - outlined in terracotta orange
   ...
   - Blocks: "cockpit-evaluation-core (DeterministicEvaluator, DualJudgeEvaluator, EvaluationPolicy, HiddenRubric)"
...
- Purple arrow from "cockpit-evaluation-core" to "cockpit-recording" labeled "reads immutable recording"
...
Files: crates/cockpit-evaluator/src/ (main.rs, suite.rs), crates/cockpit-evaluation-core/src/, crates/cockpit-judge/src/
Show:
